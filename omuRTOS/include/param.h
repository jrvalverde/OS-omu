/*******************************************************************************
 *	Param.h		System parameters for Eltec 1Mbyte OMU
 *******************************************************************************
 *
 * Notes:
...
#endif
# define	NFILES		30	/* total no. distinct files */
# define	NFPERU		20	/* no. files per user process */

# define	NPROC		10	/* total no. processes */
# define	NINODES		30	/* no. in core inode copies */
# define	NBUF		18	/* no. in core block buffers */
...
# define	NCDEVS		16	/* Number of char devs in char switch */

# define	RDEV_MAJ	2	/* Root device major (hard disk) */
# define	RDEV_MIN	0	/* Root device minor */
# define	PDEV_MAJ	1	/* Pipe major device no (RAMDISK) */
# define	PDEV_MIN	0	/* Pipe minor device no (RAMDISK) */
