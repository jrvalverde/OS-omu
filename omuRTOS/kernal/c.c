...
struct	Majseg dmem_maj[NMSEGS] = {
	...
	0, NMINSEG2, mseg2, (CA)0x020000L, (CA)0x060000L, /* Process space */
	0, NMINSEG3, mseg3, (CA)0x060000L, (CA)0x060000L, /* Process 2 space */
	0, NMINSEG4, mseg4, (CA)0x060000L, (CA)0x0E0000L, /* Swap space */
	0, NMINSEG5, mseg5, (CA)0x0E0000L, (CA)0x100000L, /* Ramdisk space */
	0, NMINSEG6, mseg6, (CA)0x100000L, (CA)0x100000L /* User addon space */
};
...
struct dev dbdevsw[NBDEVS] = {
	...
	1, 0,	  0,	    netstrat,	0,	0, 0	/* User add on */
};
...
struct dev dcdevsw[NCDEVS] = {
	...
	1, 0,	0,	0,	netread,netwrite, 0,	/* 4 = user add on */
	0, 0,	0,	0,	0,	0, 0,		/* 5 = user add on */
	0, 0,	0,	0,	0,	0, 0,		/* 6 = user add on */
	0, 0,	0,	0,	0,	0, 0,		/* 7 = user add on */
	0, 0,	0,	0,	0,	0, 0,		/* 8 = user add on */
	0, 0,	0,	0,	0,	0, 0,		/* 9 = user add on */
	0, 0,	0,	0,	0,	0, 0,		/* 10 = user add on */
	0, 0,	0,	0,	0,	0, 0,		/* 11 = user add on */
	0, 0,	0,	0,	0,	0, 0,		/* 12 = user add on */
	0, 0,	0,	0,	0,	0, 0,		/* 13 = user add on */
	0, 0,	0,	0,	0,	0, 0,		/* 14 = user add on */
	0, 0,	0,	0,	0,	0, 0		/* 15 = user add on */
};
